...
def main():
    ...
    parser.add_argument('--out_dir', default='/home/tajima/All-frequency_Full-body_Human_Image_Relighting/outputs/train_refineshadow')
    ...
    parser.add_argument('--shadow_dir', default='/home/tajima/dataset/shadow_dataset')
